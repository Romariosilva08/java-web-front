...
estrelas.forEach(estrela => {
    estrela.addEventListener('click', () => {
        ...
        mensagemAvaliacao.textContent = `Você avaliou com ${valor} estrelas!`;

        if (valor >= 4) {
            mensagemAvaliacao.style.color = "#4CAF50"; // Verde para 4-5 estrelas
        } else if (valor == 3) {
            mensagemAvaliacao.style.color = "#FF9800"; // Laranja para 3 estrelas
        } else {
            mensagemAvaliacao.style.color = "#F44336"; // Vermelho para 1-2 estrelas
        }
    });
});